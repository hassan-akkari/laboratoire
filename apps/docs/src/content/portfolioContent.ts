  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Audited and hardened multi-tenant data isolation (tenant claim filtered on the row, not via a parent join) and led a security and tenancy audit; the authorization weakness and request-validation gap it surfaced were remediated before release.",
